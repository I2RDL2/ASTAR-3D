...
### Download the data
Please email Jie Lin (lin-j@i2r.a-star.edu.sg) for the download link to A*3D dataset. Note that A*3D is only for non-commercial research purposes only, and a Non-Commercial Use Agreement needs to be signed.
